...
Say so plainly and show the synthesized text in the conversation. Do not offer
or call the tenant fallback (`set_my_profile`) on your own — the server can now
